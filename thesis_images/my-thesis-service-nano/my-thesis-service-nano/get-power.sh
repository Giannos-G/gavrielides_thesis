...
while true; do
  ...
  cat /sys/bus/i2c/devices/6-0040/iio\:device0/in_power0_input >> module-power-input.txt
  cat /sys/bus/i2c/devices/6-0040/iio\:device0/in_power1_input >> GPU-power.txt
  cat /sys/bus/i2c/devices/6-0040/iio\:device0/in_power2_input >> CPU-power.txt

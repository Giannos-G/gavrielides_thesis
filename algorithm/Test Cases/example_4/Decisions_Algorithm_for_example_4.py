...
def GetNumberOfFunctions():
    file = open("/home/giannos-g/Desktop/gavrielides_thesis/algorithm/Test Cases/example_4/python_profiling/App_Info_Output_File_CSV.csv")
...
def GetWeightsArray():
    ...
    mem_file = open("/home/giannos-g/Desktop/gavrielides_thesis/algorithm/Test Cases/example_4/python_profiling/App_Info_Output_File_CSV.csv")
    table = []
...
def GetCommunications(functions):
    ...
    source_functions_file = open('/home/giannos-g/Desktop/gavrielides_thesis/algorithm/Test Cases/example_4/python_profiling/App_Info_Output_File_CSV.csv')
    communications_file = open('/home/giannos-g/Desktop/gavrielides_thesis/algorithm/Test Cases/example_4/python_profiling/Calls_Details_CSV.csv')
...
def Energy_Prediction_Table_on_Nano():
    predictions_table = []    
    # Prediction for Nano
    with open('/home/giannos-g/Desktop/gavrielides_thesis/algorithm/Test Cases/example_4/energy_prediction_modeling/Energy_Predictions_on_nano.csv', 'r', newline='')as f:
        for line in f:
            part = line.split(',')
...
def Energy_Prediction_Table_on_Jetson():
    ...
    with open('/home/giannos-g/Desktop/gavrielides_thesis/algorithm/Test Cases/example_4/energy_prediction_modeling/Jetson_xavier_nx_00/Predictions_jetson_xavier_nx_00.csv', 'r', newline='')as f:
        for line in f:
            part = line.split(',')
            prediction_row = [part[1]]
            predictions_table.append(prediction_row) #part[0] = name of functions
...
def GetTotalTimeOnNano():
    predictions_table = []    
    # Prediction for Nano
    with open('/home/giannos-g/Desktop/gavrielides_thesis/algorithm/Test Cases/example_4/time_prediction_modeling/Nano/Time_Predictions_on_Nano.csv', 'r', newline='')as f:
        for line in f:
            part = line.split(',')
            prediction_row = [part[1]]
            predictions_table.append(prediction_row) #part[0] = name of functions
...
def GetTotalTimeOnJetson():
    predictions_table = []    
    # Prediction for Jetson
    with open('/home/giannos-g/Desktop/gavrielides_thesis/algorithm/Test Cases/example_4/time_prediction_modeling/Jetson/Time_Predictions_on_Jetson.csv', 'r', newline='')as f:
        for line in f:
            part = line.split(',')
            prediction_row = [part[1]]
            predictions_table.append(prediction_row) #part[0] = name of functions

...
def main():
    ...
    predict_table = []
    info_table = []
    with open('/home/giannos-g/Desktop/gavrielides_thesis/python_profiling/App_Info_Output_File_CSV.csv', 'r', newline='')as f:
    ...
    with open('/home/giannos-g/Desktop/gavrielides_thesis/time_prediction_modeling/Nano/Time_Predictions_on_Nano.csv', 'w', newline='')as f:

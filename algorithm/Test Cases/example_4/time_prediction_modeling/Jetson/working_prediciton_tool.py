...
def main():
    ...
    with open('/home/giannos-g/Desktop/gavrielides_thesis/algorithm/Test Cases/example_4/time_prediction_modeling/Jetson/Time_Predictions_on_Jetson.csv', 'w', newline='')as f:

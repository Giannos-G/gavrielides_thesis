...
def main():
    ...
    # Open the txt files
    memory_profiler = open(r"/home/giannos/Desktop/Memory_Profiling.txt", "r")
    time_profiler = open(r"/home/giannos/Desktop/Time_Profiling.txt", "r")
    ...
    my_output_file = open("/home/giannos/Desktop/profiling_outputs/App_Info_Output_File.txt", "w")
    current = LL.head
    number = 1
    my_output_file.write("#, Name, Memory, Time, nCalls \n")
    while (current):
        my_output_file.write(str(number))
        my_output_file.write(", ")
        my_output_file.write(current.name)
        my_output_file.write(", ")
        my_output_file.write(str(current.memory))
        my_output_file.write(", ")
        my_output_file.write(str(current.time))
        my_output_file.write(", ")
        my_output_file.write(str(current.ncalls))
        my_output_file.write("\n")
        current = current.next_node
        number = number +1

...
def main():
    ...
    with open('/home/giannos-g/Desktop/gavrielides_thesis/algorithm/Test Cases/example_3/energy_prediction_modeling/Energy_Predictions_on_nano.csv', 'w', newline='')as f:

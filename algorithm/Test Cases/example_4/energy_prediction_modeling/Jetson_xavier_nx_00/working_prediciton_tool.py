...
def main():
    ...
    with open('/home/giannos-g/Desktop/gavrielides_thesis/algorithm/Test Cases/example_4/energy_prediction_modeling/Jetson_xavier_nx_00/Predictions_jetson_xavier_nx_00.csv', 'w', newline='')as f:

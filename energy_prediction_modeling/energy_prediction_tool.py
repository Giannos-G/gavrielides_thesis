...
plt.scatter(data['Time(s)'], data['Energy(Joule)'])
plt.title('Energy = f(Time)')
plt.xlabel('Time (s)')
...
plt.xlim(0, 25)
plt.ylim(0, 100)
plt.title('Energy = f(Time) -with limits-')
plt.xlabel('Time (s)')
plt.ylabel('Energy (Joule)')
plt.show()

#------------------Show Original Memory Vs Energy------------------
plt.scatter(data['Memory(MB)'], data['Energy(Joule)']) 
plt.title('Energy = f(Memory)')
...
plt.xlim(0, 500)
plt.ylim(0, 1000) 
plt.title('Energy = f(Memory) -with limits-')
plt.xlabel('Memory (MB)')
plt.ylabel('Energy (Joule)')
plt.show()
...
data.drop('Energy(Joule)', axis=1, inplace=True)

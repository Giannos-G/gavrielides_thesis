...
def tree_regression_compare_4():
    ...
    regr_2 = DecisionTreeRegressor(max_depth=3)
    regr_3 = DecisionTreeRegressor(max_depth=4)
    regr_4 = DecisionTreeRegressor(max_depth=7)
    regr_1.fit(X, y)
    regr_2.fit(X, y)
    regr_3.fit(X, y)
    regr_4.fit(X, y)
...
def lasso_regression_compare_4():
    ...
    regr_1 = Lasso(alpha=1.0)
    regr_2 = Lasso(alpha=1.2)
    regr_3 = Lasso(alpha=1.4)
    regr_4 = Lasso(alpha=1.6)
    regr_1.fit(X, y)
    regr_2.fit(X, y)
    regr_3.fit(X, y)
    regr_4.fit(X, y)
...
def bayesian_ridge_regression():
    ...
    # Fit regression model
    regr_1 = BayesianRidge(compute_score=True) 
    regr_2 = BayesianRidge(compute_score=False) 
    regr_1.fit(X, y)
    regr_2.fit(X, y)
...
def main():
    ...
    tree_regression_depth_2()
    print ("tree_regression_depth_2() finished \n")
    tree_regression_depth_3()
    print ("tree_regression_depth_3() finished \n")
    tree_regression_depth_4()
    ...
    print ("bayesian_ridge_regression() finished \n")

...
#------------------Show Original Time on Local Vs Time on Nano------------------
plt.scatter(data['Time on local(s)'], data['Time on Nano(s)'])
plt.title('Time on Nano(s) = f(Time on local(s))')
plt.xlabel('Time on local(s)')
plt.ylabel('Time on Nano(s)')
plt.show()

#------------------Show Time on Local Vs Time on Nano with limits------------------
plt.scatter(data['Time on local(s)'], data['Time on Nano(s)'])
plt.xlim(0, 25)
plt.ylim(0, 100)
plt.title('Time on Nano(s) = f(Time on local(s)) -with limits-')
plt.xlabel('Time on local(s)')
plt.ylabel('Time on Nano(s)')
plt.show()

#------------------Show Original Memory Vs Time on Nano------------------
plt.scatter(data['Memory(MB)'], data['Time on Nano(s)']) 
plt.title('Time on Nano(s) = f(Memory)')
plt.xlabel('Memory (MB)')
plt.ylabel('Time on Nano(s)')
plt.show()

#------------------Show Memory Vs Time on Nano with limits------------------
plt.scatter(data['Memory(MB)'], data['Time on Nano(s)'])
plt.xlim(0, 500)
plt.ylim(0, 1000) 
plt.title('Time on Nano(s) = f(Memory) -with limits-')
plt.xlabel('Memory (MB)')
plt.ylabel('Time on Nano(s)')
plt.show()

#------------------Boxplot of the data------------------
data.boxplot(['Memory(MB)', 'Time on local(s)', 'Time on Nano(s)'])
plt.ylim(0, 350)
...
data_out.boxplot(['Memory(MB)', 'Time on local(s)', 'Time on Nano(s)'])
...
train_target = data['Time on Nano(s)']

#--------------Exclude the target column from the dataset--------------
data.drop('Time on Nano(s)', axis=1, inplace=True)
...
plt.scatter(my_x_axis, y_pred_lr_test, color = 'blue', label = 'Predicted Values')
...
ax.set_ylabel('Time on Nano(s)')
ax.set_title('Predicted and Actual Values using Linear Regression')
ax.set_xticks(x)

...
os.system('mprof run --python --interval 0.01 --output memory_profiling.txt example.py')
...
# Edit the csv file
creator = open('Energy_Profiling_Details_CSV.csv', 'a+')            # Create it if it does not exist

with open('Energy_Profiling_Details_CSV.csv', 'r', newline='')as f: # Count the number of lines
    lines_count = len(f.readlines())
    #print (lines_count)
  
with open('Energy_Profiling_Details_CSV.csv', 'a+', newline='' )as f:

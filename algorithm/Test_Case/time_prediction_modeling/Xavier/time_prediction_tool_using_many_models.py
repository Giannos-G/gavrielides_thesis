...
#--------------Uploading dataset--------------
data = pd.read_csv("/home/giannos-g/Desktop/gavrielides_thesis/algorithm/Test_Case/time_prediction_modeling/Jetson/Time_profiling_Jetson_details.csv")
...
#------------------Show Time on Local Vs Time on Xavier with limits------------------
plt.scatter(data['Time on local(s)'], data['Time on Jetson(s)'])
plt.xlim(0, 25)
plt.ylim(0, 100)
